            ...
            <div class="col-sm-4">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                            <p>
                                <img class="img-thumbnail" src="<?php echo BASE_URL; ?><?php echo $produtos[24]['imagem']; ?>" alt="<?php echo $produtos[24]['descricao']; ?>">
                                <h4><?php echo $produtos[24]['descricao']; ?></h4>
                            </p>
                            <p class="preco espaco">
                                <img src="<?php echo BASE_URL; ?>public/img/store/others/avancoins.png" alt="Ventilador de Mesa">
                                <?php echo $produtos[24]['valor']; ?>
                            </p>
                            <p class="comprar">
                                <button class="btn btn-info btn-lg btn-block" type="button" value="<?php echo $produtos[24]['id']; ?>">Comprar</button>
                            </p>
                        </div>
                    </div>
                </div>

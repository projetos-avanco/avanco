...
require_once DIRETORIO_MODULES . 'schedule/modulo_cancelamento.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['pagina']) && $_POST['pagina'] === 'externo') {
    solicitaEnvioDeEmailDeCancelamentoExterno($id, $cnpj, $contato, $copia);
  } elseif (isset($_POST['pagina']) && $_POST['pagina'] === 'remoto') {
    solicitaEnvioDeEmailDeCancelamentoRemoto($id, $cnpj, $contato, $copia);
  }
}
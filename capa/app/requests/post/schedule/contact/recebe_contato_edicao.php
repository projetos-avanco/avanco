...
if (isset($_POST['submit']) && $_POST['submit'] == 'submit') {
  ...
  if (!empty($_POST['contato']['id-contato'])) {
    $idContato = $_POST['contato']['id-contato'];
  }else {
    $validacao['flag']    = true;
    $validacao['erros'][] = 'O Código do Contato não foi Informado';
  }
  ...
  if ($validacao['flag']) {
    ...
    header('Location:' . BASE_URL . 'public/views/schedule/contact/edita_contato.php?id=' . $idContato); exit;
  } else {
    ...
    # chamando função responsável por solicitar a atualização dos dados do contato
    recebeContatoParaEdicao($idContato, $nome, $fixos, $moveis, $emails);
  }
}
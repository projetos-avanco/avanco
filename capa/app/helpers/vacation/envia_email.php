...
/**
 * envia um email de confirmação de inserção de exercício de férias
...
function enviaEmailDeConfirmacaoDeExercicioDeFerias($emailColaborador, $inicial, $final, $vencimento)
{
              ...
              <div class='text-left'>            
                ...
                <div style='text-size-adjust: none !important; -ms-text-size-adjust: none !important; -webkit-text-size-adjust: none !important;'>
                  ...
                  <p style='font-family: Helvetica, Arial, sans-serif; font-size: 10px; line-height: 12px; color: rgb(33, 33, 33); margin-bottom: 10px;'>
                    <span style='font-weight: bold; color: rgb(33, 33, 33); display: inline;'> Bruno César</span>
                    ...
                    <span style='display: inline;'><br></span>
                      <a href='mailto: iuri@avancoinfo.com.br' style='color: rgb(71, 124, 204); text-decoration: none; display: inline;'> bruno@avancoinfo.com.br</a>
  ...
  try {
    ...
    # destinatários
    $email->setFrom('wellington.felix@avancoinfo.com.br', 'Avanço | Férias');

...
<?php if (verificaUsuarioLogado('relatorio_folgas.php')) : ?>
...
<head>
  ...
  <title>Portal Avanção - Consulta Gerencial - Relatório de Folgas</title>
...
<body>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <h2>Consulta Gerencial - Relatório de Folgas</h2>
              <hr>
            </div>
          </div>
        </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="motivo" name="motivo">
                          ...
                          <optgroup label="Pessoal">
                            <option value="1">Abater nas Horas</option>
  ...
  <script src="<?php echo BASE_URL; ?>public/js/schedule/records/adm/gera_relatorio_folgas.js"></script>    
</body>
</html>

...
<?php if (verificaUsuarioLogado('cancela_atendimento_externo.php')) : ?>
...
<head>
  ...
  <title>Portal Avanção - Cancelamento Atendimento Externo</title>
...
<body>
  ...
  <?php include ABS_PATH . 'inc/templates/sidebar.php' ?>
        ...
        <div class="row">
          <div class="col-sm-12">
            <h2>Cancelamento Atendimento Externo</h2>
            <hr>
          </div>
        </div>

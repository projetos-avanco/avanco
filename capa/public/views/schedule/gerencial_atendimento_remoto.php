...
<?php if (verificaUsuarioLogado('gerencial_atendimento_remoto.php')) : ?>
...
<head>
  ...
  <title>Portal Avanção - Consulta Gerencial Atendimento Remoto</title>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <h2>Consulta Gerencial Atendimento Remoto</h2>
              <hr>
            </div>
          </div>
        </div>

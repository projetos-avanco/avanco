...
<?php if (verificaUsuarioLogado('confirma_atendimento_remoto.php')) : ?>
...
<head>
  ...
  <title>Portal Avanção - Confirmação Atendimento Remoto</title>
...
<body>
  ...
  <?php include ABS_PATH . 'inc/templates/sidebar.php' ?>
        ...
        <div class="row">
          <div class="col-sm-12">
            <h2>Confirmação Atendimento Remoto</h2>
            <hr>
          </div>
        </div>

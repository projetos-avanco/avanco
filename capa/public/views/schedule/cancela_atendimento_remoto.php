...
<?php if (verificaUsuarioLogado('cancela_atendimento_remoto.php')) : ?>
...
<head>
  ...
  <title>Portal Avanção - Cancelamento Atendimento Remoto</title>
...
<body>
  ...
  <?php include ABS_PATH . 'inc/templates/sidebar.php' ?>
        ...
        <div class="row">
          <div class="col-sm-12">
            <h2>Cancelamento Atendimento Remoto</h2>
            <hr>
          </div>
        </div>

        <form action="<?php echo BASE_URL; ?>app/requests/post/schedule/confirmation/recebe_cancelamento_atendimento.php" method="post">
          ...
          <div class="row">          
            <div class="col-sm-6 col-sm-offset-3">
              ...
              <div class="panel panel-info"><!-- panel -->
                ...
                <input type="hidden" name="pagina" value="remoto">
              </div><!-- panel -->

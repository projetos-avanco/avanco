...
<?php if (verificaUsuarioLogado('edita_extras.php')) : ?>
...
<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'GET') {    
    ...
    if (isset($id)) {
      ...
      $extra = retornaDadosDoRegistroDeExtra($id);      
    }    
  }
?>
...
<head>
  ...
  <title>Portal Avanção - Edição de Extras</title>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <h2>Edição de Extras</h2>
              <hr>
            </div>
          </div>
        </div>
        
        <form action="<?php echo BASE_URL; ?>app/requests/post/schedule/records/recebe_edicao_extra.php" method="post">
            ...
            <div class="col-sm-6 col-sm-offset-3"><!-- primeira coluna principal -->
              ...
              <div class="row"><!-- painel atendimentos -->
                <div class="col-sm-12">
                  ...
                  <input type="hidden" name="extras[id]" value="<?php echo $extra['id']; ?>">
                </div>
  ...
  <script>
    $(function() {
      ...
      $(document).on('click', '#btn-voltar', function(e) {
        ...
        url = tmp[0]+'//'+tmp[2]+'/'+tmp[3]+'/'+tmp[4]+'/public/views/schedule/relatorio_extras.php';

...
<body>
            ...
            <div class="col-sm-3 col-sm-offset-9">
              <div class="form-group">
                <div class="input-group">
                  <input class="form-control" id="pesquisa" type="text" placeholder="Pesquise pelo CNPJ ou a Razão Social">
                          ...
                          <div class="panel-body">
                            ...
                            <div class="row">
                              <div class="col-sm-4 col-sm-offset-8">
                                <div class="form-group">
                                  <button class="btn btn-default btn-sm btn-block" id="nova-empresa" type="button">
                                    <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Nova Empresa
                                  </button>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="panel panel-info">
                          ...
                          <div class="panel-body">
                            ...
                            <div class="row">
                              <div class="col-sm-3 col-sm-offset-9">
                                <div class="form-group">
                                  <button class="btn btn-default btn-sm btn-block" id="novo-contato" type="button">
                                    <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Novo Contato
                                  </button>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="panel panel-info">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="row">
                          <div class="col-sm-3 col-sm-offset-9">
                            <div class="form-group">
                              <button class="btn btn-default btn-sm btn-block" id="novo-endereco" type="button">
                                <span class="glyphicon glyphicon-road" aria-hidden="true"></span> Novo Endereço
                              </button>
                            </div>
                          </div>
                        </div>
  ...
  <script src="<?php echo BASE_URL; ?>public/js/schedule/remote/direciona_usuario.js"></script>

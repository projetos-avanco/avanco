...
<?php if (verificaUsuarioLogado('relatorio_faltas.php')) : ?>
...
<head>
  ...
  <title>Portal Avanção - Consulta Gerencial - Relatório de Faltas</title>
...
<body>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <h2>Consulta Gerencial - Relatório de Faltas</h2>
              <hr>
            </div>
          </div>
        </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="motivo" name="motivo">
                          ...
                          <optgroup label="Pessoal">
                            <option value="1">Descontar o Dia</option>
                          </optgroup>
  ...
  <script src="<?php echo BASE_URL; ?>public/js/schedule/records/adm/gera_relatorio_faltas.js"></script>    
</body>
</html>
